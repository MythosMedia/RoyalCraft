...
function initBalkon() {
  ...
  u.html(`
  <a href="booking" class="share-icon calendar-icon">
    <i class="fa fa-calendar"></i>
  </a>
  <a href="tel:+1 604 724 0009" class="share-icon phone-icon">
    <i class="fa fa-phone"></i>
  </a>
  <a href="mailto:jass@royalcrafthomes.ca" class="share-icon email-icon">
